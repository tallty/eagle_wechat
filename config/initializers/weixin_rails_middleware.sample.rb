...
WeixinRailsMiddleware.configure do |config|
  ...
  # config.weixin_token_string = '9dcd6e868302fef1fb283dc5'
  # using to weixin server url to validate the token can be trusted.
  # config.weixin_secret_string = '1xHs8vCUxqv3byuuNvT8z7qeW7Sq1hIa'
  # 加密配置，如果需要加密，配置以下参数
  # config.encoding_aes_key = 'd530c278731a43a7e23e819de7a541e16d4ffab0204'
