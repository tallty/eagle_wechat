class SendReport
  ...
  def self.send_report
    ...
    articles << {:title => "#{today.strftime('%Y年%m月%d日监控报表')}", :url => "http://mcu.buoyantec.com/oauths?target_url=reports", :picurl => "http://mcu.buoyantec.com/assets/images/day_report.png"}
